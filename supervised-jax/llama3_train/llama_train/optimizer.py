...
from typing import Tuple, NamedTuple, Dict, Any, Optional, Callable
import optax
...
def load_palm_optimizer(
    ...
    def learning_rate_schedule(step):
        multiplier = lr / 0.01
        return multiplier / jnp.sqrt(jnp.maximum(step, lr_warmup_steps))

    def weight_decay_schedule(step):
        multiplier = weight_decay / 1e-4
