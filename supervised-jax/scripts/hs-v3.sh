...
python llama_train_script.py \
    ...
    --train_data_path="gcs://jiayi-eu/data/v3/train_hs.json" \
    --eval_data_path="gcs://jiayi-eu/data/v3/val_hs.json" \
    --output_dir="gcs://jiayi-eu/lm-parallel-exp/exp-hs/" \
    --sharding="-1,1,1" \
    ...
    --hf_repo_id="LM-Parallel/llama-hsp-v3"
)
