...
export RUN_NAME="llama-200m-sos-v2"
...
python llama_train_script.py \
    ...
    --train_data_path="gcs://jiayi-eu/data/v3/train_sos.json" \
    --eval_data_path="gcs://jiayi-eu/data/v3/val_sos.json" \
    ...
    --hf_repo_id="LM-Parallel/llama-sos-v3"
)
