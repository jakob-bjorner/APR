...
export RUN_NAME="llama-200m-hsp-v2"
...
python llama_train_script.py \
    ...
    --train_data_path="gcs://jiayi-eu/data/hsp-v2/train.json" \
    --eval_data_path="gcs://jiayi-eu/data/hsp-v2/test.json" \
    ...
    --hf_repo_id="LM-Parallel/llama-hsp-v2-8k-step"
)
