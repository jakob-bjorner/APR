...
export RUN_NAME="llama-300m-gpt2tok-standard-500k-1ep-bs128-valid"
...
python llama_train_script.py \
    --load_model="paths:{
        \"tokenizer\": \"gpt2\",
        \"default_config_name\": \"300m\"
    }" \
    --train_data_path="gcs://jiayi-eu/data/sos-jan12-xiuyu/train.json" \
    --eval_data_path="gcs://jiayi-eu/data/sos-jan12-xiuyu/test.json" \
    ...
    --hf_repo_id="LM-Parallel/llama-300m-gpt2tok-standard-valid-5e-5-bs128-1ep"
)
